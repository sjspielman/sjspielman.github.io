...
{\bf Assistant Professor} \hfill {Beginning Fall 2018} \\
...
recombination and other forces.'' \emph{In: Anisimova M. (eds) Evolutionary Genomics. Methods in Molecular Biology (Methods and Protocols).} Humana Press. In Press.  
...
\item \textbf{SJ Spielman} and SL Kosakovsky Pond. 2018. ``Relative evolutionary rates in proteins are largely insensitive to the substitution model.'' \emph{Under Review}.
\begin{itemize}
\item Preprint available from \emph{bioRxiv}: \url{https://doi.org/10.1101/304758}.
\end{itemize}
\vspace{0.5cm}

\item R Maddamsetti, DT Johnson, \textbf{SJ Spielman}, KL Petrie, DS Marks, and JR Meyer. ``Viral gain-of-function experiments uncover residues under diversifying selection in nature. \emph{Under Review}.
\begin{itemize}
\item Preprint available from \emph{bioRxiv}: \url{https://doi.org/10.1101/242495}.
\end{itemize}
\vspace{0.5cm}
...
\textbf{Peer Reviewer} \\ \emph{Molecular Biology and Evolution}, \emph{Genome Biology and Evolution}, \emph{PLoS Computational Biology}, \emph{Philosophical Transactions of the Royal Society B}, \emph{Journal of Molecular Evolution}, \emph{BMC Evolutionary Biology}, \emph{PeerJ}
