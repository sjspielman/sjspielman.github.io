...
\begin{table}[H]
	\begin{tabular}{ll}
		...
		Website & \url{http://spielmanlab.io} \\
	\end{tabular}
\end{table}
\end{rSection}
\vspace*{-0.45cm}
...
\textbf{Instructor, Introduction to Biocomputing Weekly Short Course} \hfill 2018 -- Present \\ Rowan University \\
...
\textbf{Peer Reviewer} \\ \emph{Molecular Biology and Evolution}, \emph{Genome Biology and Evolution}, \emph{PLoS Computational Biology}, \emph{Bioinformatics}, \emph{BMC Evolutionary Biology},  \emph{BMC Bioinformatics}, \emph{PeerJ}, \emph{Philosophical Transactions of the Royal Society B}, \emph{Genes}, \emph{Journal of Molecular Evolution}
